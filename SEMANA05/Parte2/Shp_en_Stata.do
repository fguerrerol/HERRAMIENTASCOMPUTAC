...
spmap crimecount using coord_ls, id(id) clmethod(q) cln(6) title("Número de crímenes") legend(size(medium) position(5) xoffset(15.05)) fcolor(Reds2) plotregion(margin(b+15)) ndfcolor(gray) name(g1,replace)  
