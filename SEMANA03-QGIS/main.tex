...
\begin{figure}[!h]
    \centering
    \subfigure[]{\includegraphics[width=8cm]{Part2 graph1.png}}
    \subfigure[]{\includegraphics[width=8cm]{Part2 graph2.png}}
...
\begin{figure}[!h]
    \centering
    \subfigure[]{\includegraphics[width=8cm]{Part2 graph3.png}}
    \subfigure[]{\includegraphics[width=8cm]{Part2 graph4.png}}
